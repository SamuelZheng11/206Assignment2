...
public class MainMenu implements ActionListener {
	...
	public void setupMenu() {
		...
		introLabel = new JLabel("Hello and welcome to maths audio/visual aid");
		...
		instruction = new JLabel("Please select one of the options from the drop down box then press proceed");
		...
		// add a combo box to the drop down box panel
		userSelection = new JComboBox();
		dropDownBoxPanel.add(userSelection);
		// add selection options for combo box
		userSelection
				.setModel(new DefaultComboBoxModel(new String[] { "List/Play/Delete Creations", "Make a Creation" }));
